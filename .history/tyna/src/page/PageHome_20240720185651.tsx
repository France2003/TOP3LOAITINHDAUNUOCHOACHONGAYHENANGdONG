    ...
    return (
        <div className='mt-32 mb-5 w-[1120px]  flex justify-around flex-col  m-auto leading-7 '>
            ...
            <div className='mx-9 mt-4'>
                ...
                <img src={img4I} className='w-[1050px] h-[450px] m-auto' alt="Tinh dầu nước hoa Matcha Chilling Day" />
            ...
            <div className='mx-9 mt-4'>
                ...
                <img src={img4II} className='w-[1050px] h-[450px] m-auto' alt="Tinh dầu nước hoa Love Letter" />
