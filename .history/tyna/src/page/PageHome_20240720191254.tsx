    ...
    return (
        <div className='mt-32 mb-5 w-[1120px]  flex justify-around flex-col  m-auto leading-7 '>
            ...
            <div className='mx-9'>
                ...
                <p className='text-[17px]'><b>Matcha Chilling Day</b> nằm trong <a href="https://sonice.com.vn/blogs/news/top-3-tinh-dau-huong-nuoc-hoa-duoc-ua-chuong-nhat-tai-so-nice" className='decoration-solid text-blue-500'>top 3 tinh dầu nước hoa được giới trẻ ưa chuộng</a> với mùi hương dịu mát và tươi mới.
